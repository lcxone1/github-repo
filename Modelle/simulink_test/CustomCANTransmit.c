 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Dec 08 13:39:05 2022
 */
...
extern void CustomCANTransmit_Outputs_wrapper(const CAN_MESSAGE_BUS *u0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  (_u0BUS).Extended = *((uint8_T*)((char *) u0 + busInfo[0].offset));
  (_u0BUS).Length = *((uint8_T*)((char *) u0 + busInfo[1].offset));
  (_u0BUS).Remote = *((uint8_T*)((char *) u0 + busInfo[2].offset));
  (_u0BUS).Error = *((uint8_T*)((char *) u0 + busInfo[3].offset));
  (_u0BUS).ID = *((uint32_T*)((char *) u0 + busInfo[4].offset));
  (_u0BUS).Timestamp = *((real_T*)((char *) u0 + busInfo[5].offset));
  (void) memcpy((_u0BUS).Data, (char *) u0 + busInfo[6].offset, 8*busInfo[6].
                elemSize);
  CustomCANTransmit_Outputs_wrapper(&_u0BUS);
